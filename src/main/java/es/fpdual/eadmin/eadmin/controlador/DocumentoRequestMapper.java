...
public class DocumentoRequestMapper {
	...
	public static Documento toDocumentoCompleto(DocumentoRequest documentoRequest, int id, LocalDate fechaCreacion) {
		return new Documento(id, documentoRequest.getNombre(), construyeUsuario(documentoRequest), fechaCreacion,
				construyeTipoDocumento(documentoRequest.getTipoDocumento()));
