	...
	public void altaDocumento(Documento documento) {
		...
		try {
			if (!archivo.exists()) {
				...
				String textoAImprimirEnFichero = "ID: " + documento.getId() + "Nombre: " + documento.getNombre()
						+ "Fecha: " + documento.getFechaCreacion() + "Tipo Documento: " + documento.getTipoDocumento()
	...
	public List<Documento> obtenerTodosDocumentos() {
		...
		try {
			...
			for (Documento documento : documentos) {
				...
				impFichero.println("Fecha: " + documento.getFechaCreacion());
